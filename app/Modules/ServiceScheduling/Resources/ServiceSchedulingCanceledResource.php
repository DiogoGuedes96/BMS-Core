...
class ServiceSchedulingCanceledResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            $this->mergeWhen($this->canceled, [
                "canceled" => SchedulingServiceCanceledDetailsResource::make($this->canceled)
            ])
        ];
    }
}
