...
class EditUniClientsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'email' => ['required', 'email', 'max:255', 'unique:uni_clients,email,' . $id],
            ...
            'type_business' => ['nullable', 'string', 'in:'.implode(',',StatusTypeBusinessEnum::getAll())],
            'status' => ['required']
        ];
    }
